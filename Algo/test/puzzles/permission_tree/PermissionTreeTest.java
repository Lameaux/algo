...
public class PermissionTreeTest {
	...
	public void test0() {
		...
		assertArrayEquals(result, tree.findHome(folders, users));
	}

	@Test
	public void test1() {
		String[] folders = new String[] { "0 Admin" };
		String[] users = new String[] { "Peter", "Paul", "Mary" };
	...
	@Test
	public void test3() {
		String[] folders = new String[] { "0 Admin", "0 Jeff", "1 Mark,Tim", "1 Tim,Jeff", "0 Dan", "4 Ed", "4 Tom", "4 Kyle,Ed", "0 Ben", "8 Rich", "8 Sam",
				"8 Tim" };
		String[] users = new String[] { "Jeff", "Ed", "Tim", "Steve" };
		// Example has 0 for Tim, but it is wrong, should be { 1,  4,  0,  -1 };
		int[] result = new int[] { 1,  4,  1,  -1 };
		assertArrayEquals(result, tree.findHome(folders, users));
	}

	@Test
	public void test4() {
		String[] folders = new String[] { "0 Admin", "0 Bob,Joe,Bob", "0 Joe" };
		String[] users = new String[] { "Joe", "Bob" };
